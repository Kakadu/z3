...
class dl_lambda_cmd : public cmd {
    ref<dl_context> m_dl_ctx;
public:
    dl_lambda_cmd(dl_context * dl_ctx):
      cmd("lambda"),
      m_dl_ctx(dl_ctx)
    {}

    char const * get_usage() const override { return "TODO: help for lambda here "; }
    char const * get_descr(cmd_context & ctx) const override { return "Lambdas are the best"; }
    unsigned get_arity() const override { return 0; }
    void execute(cmd_context & ctx) override {
//        m_dl_ctx->pop();
    }
